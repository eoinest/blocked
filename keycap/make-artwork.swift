...
<desc>Transparent nominal placement canvas, not a keycap dimensional drawing. Black legend 9 mm wide, 2 mm from left and bottom. Preserve placement; confirm on vendor proof. Lettering is paths, no embedded font.</desc>
<path fill="#000000" d="\(commands.joined(separator: " "))"/>
</svg>
"""
...
func render(filename: String, preview: Bool) throws {
    ...
    ctx.setFillColor(CGColor(gray: 0, alpha: 1)); ctx.addPath(artwork); ctx.fillPath()
