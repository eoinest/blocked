# Print two complete buttons

Download [the single six-part STL](../enclosure/stl/blocked-two-devices-blank-caps.stl).
It contains **two bases, two lids, and two blank 1.5u-style Tab keycaps** using the
latest socket-hugging USB collar. There are no engraved words or underside IDs
on either cap. No fit coupons or electronics are included in this plate.
...
- Import in **millimeters at 100% scale**. The six parts occupy 98 × 114 mm, centered
...
- **Preserve their supplied positions and orientation.** Bases are floor-down;
  ...
  If Bambu Studio asks about multiple objects, keep all six shells and their
...
both complete bases; see [USB fit details](usb-fit.md).

The [validation report](../enclosure/two-device-plate-validation.json) records
six manifold, connected, positive-volume parts after reimporting the exported
...
/Applications/Blender.app/Contents/MacOS/Blender \
  ...
  --python enclosure/two-device-plate.py
```
