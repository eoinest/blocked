...
| M2 × 8 case screws | Ordered Maierke socket-cap kit: 8 mm under-head length; reference envelope Ø3.98 × 2 mm, 1.5 mm hex drive. [Dimension sources](fastener-fit.md). | Kit head dimensions are unpublished and must be measured; modeled threads/drive recesses are simplified. |
| M1.6 × 4 PCB screws | Same kit: 4 mm under-head length; reference envelope Ø3.14 × 1.6 mm, 1.5 mm hex drive. [Dimension sources](fastener-fit.md). | Actual head dimensions and PCB thickness control clearance and engagement. |
| Captive hex nuts | Kit lists M1.6 nuts as AF3.5 mm and M2 nuts as AF4 mm. Thickness references and pocket assumptions are recorded in the [fastener audit](fastener-fit.md). | Actual thickness, across-corners size, pocket shrinkage, anti-rotation fit and printed strength need measurement and coupons. No heat-set inserts remain in the design. |
